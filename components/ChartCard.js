        ...
        <div className="px-[10px] pr-3">
          <div className="w-full flex  flex-row items items-center justify-between pt-[5px] pb-5 border-b border-black/10 font-sans font-bold">
            <span className="flex flex-row items-center">
              <h1 className="text-[##27333C] text-xs md:text-base mr-1">
                {title}
              </h1>
              {subTitle ? (
                <span className="text-btn-light-grey text-xs md:text-base font-normal">
                  {subTitle}
                </span>
              ) : null}{" "}
            </span>
            <button className="text-btn-blue text-xs md:text-[14px]">
              {detail}
            </button>
          </div>
          <div className="w-full mt-5 flex flex-row flex-start items-center gap-6">
            {legend1 ? (
              <div className="w-1/2 md:w-1/4 flex flex-row items-center gap-2">
